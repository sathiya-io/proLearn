<?php include '../source/base_head.php'; ?>
    <div id="top" data-page="infants_kids"></div>
    <div id="page" class="animsition equal" data-animsition-in="fade-in" data-animsition-out="fade-out-up-sm" data-loader-type="loader2" data-page-loader-text="Volar" style="transform-origin: 50% 50vh;">
            ...
            <div id="workCopy">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3  text-right">
                        <a href="blog.html" class="btn btn-animated btn-split btn-dark-transparent ripple-alone animsition-link" data-animsition-out="fade-out-up-sm" data-animsition-out-duration="500" data-text="lunch project"><span>go to the website</span></a>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="container padding-bottom-100">
            <div id="images-slider-1" class="blog-item-slider owl-carousel carousel dots-under">
                <img src="../img/projects/candid/sample1/1440x900.png" alt="">
                <img src="../img/projects/candid/sample1/1440x900.png" alt="">
                <img src="../img/projects/candid/sample1/1440x900.png" alt="">
            </div>
        </div>
